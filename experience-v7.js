...
export function createExperience({game,sceneEl,pick,cancel,undo,flip,audio,getSelection,getLegal,onCursor,castleAttempt}){
 ...
 function autoFullscreen(){if(handheld||fullscreenDismissed||document.fullscreenElement||immersive)return;if(matchMedia('(pointer:fine) and (min-width:851px)').matches)void enterFullscreen()}
